...
class Single_Linked_List
{
    ...
    public:
        ...
        void push_front(const Item_Type& item)
        {
            ...
            // Assigns the next pointer of the node that the "newNode" pointer points to the same value as the head pointer
            newNode->next = head;
        ...
        {
            // Creates a pointer "newNode" for the node that will be added to the back
